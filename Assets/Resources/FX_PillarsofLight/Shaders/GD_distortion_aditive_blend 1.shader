...
Shader "GD/Particles/Distortion3"
{
	Properties
	{
	...
	Category 
	{
		...
		LOD 0
			...
			Tags { "Queue"="Background" "IgnoreProjector"="True" "RenderType"="Opaque" "PreviewType"="Plane" }
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 temp_output_140_0 = ( tex2D( _Flipbook, ( float4( fbuv147, 0.0 , 0.0 ) + ( ( tex2DNode120.a * tex2DNode121.a * tex2DNode121 * tex2DNode120 ) * _Distortion ) ).rg ) * 2.0 );
					

					fixed4 col = ( i.color.a * ( ( i.color * temp_output_140_0 ) * ( temp_output_140_0 * _Add_Blend ) ) );
...
/*ASEBEGIN
Version=18100
692.8;169.6;1534;535;2573.508;-529.6603;2.524123;True;True
Node;AmplifyShaderEditor.Vector4Node;111;-2080.665,1937.716;Float;False;Property;_SpeedTex1;Speed Tex1;3;0;Create;True;0;0;False;0;False;0.21,0.12,-0.06,-0.36;0.02,-0.66,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-1438.879,2125.844;Inherit;False;Property;_Wave;Wave;6;0;Create;True;0;0;False;0;False;1.53;0.63;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;118;-1606.005,1587.677;Float;True;Property;_Tex1;Tex1;1;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;148;-1213.092,1335.607;Inherit;False;Property;_Colums;Colums;7;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;149;-1214.612,1436.4;Inherit;False;Property;_Rows;Rows;8;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;126;-697.2817,2069.157;Inherit;False;Property;_Distortion;Distortion;5;0;Create;True;0;0;False;0;False;-0.13;-0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;127;-332.884,1555.09;Inherit;True;Property;_Flipbook;Flipbook;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;138;112.3657,1725.006;Inherit;False;Constant;_Float2;Float 2;4;0;Create;True;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;306.3103,1565.737;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;145;-6.113647,1179.173;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;139;15.61564,1877.709;Inherit;False;Property;_Add_Blend;Add_Blend;2;0;Create;True;0;0;False;0;False;0;1.1;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;142;434.3998,1893.086;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;143;450.5554,1181.931;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;144;637.3801,1726.014;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;146;706.9258,1429.062;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;141;-312.2513,1207.486;Inherit;False;Property;_Color0;Color 0;4;0;Create;True;0;0;False;0;False;0.4339623,0.4073514,0.4073514,1;0.5566038,0.5566038,0.5566038,0.4980392;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;156;945.152,1379.481;Float;False;True;-1;2;ASEMaterialInspector;0;7;GD/Particles/Distortion;0b6a9f8b4f707c74ca64c0be8e590de0;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;3;1;False;-1;10;False;-1;0;1;False;-1;1;False;-1;False;False;True;2;False;-1;True;True;True;True;False;0;False;-1;False;True;2;False;-1;True;3;False;-1;False;True;4;Queue=Background=Queue=0;IgnoreProjector=True;RenderType=Opaque=RenderType;PreviewType=Plane;False;0;False;False;False;False;False;False;False;False;False;False;True;0;0;;0;0;Standard;0;0;1;True;False;;0
...
WireConnection;146;0;145;4
WireConnection;146;1;144;0
WireConnection;156;0;146;0
ASEEND*/
//CHKSM=FEEFA71C94564FFF9FED699C7AD5CC4E4DD2E7F3